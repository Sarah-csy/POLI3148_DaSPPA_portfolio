...
-   `left_join`: Merge and only keep observations whose identifiers (matching keys) that appear in the left-hand-side table.

-   `right_join`: Merge and only keep observations whose identifiers (matching keys) that appear in the right-hand-side table.

-   `inner_join`: Merge and only keep observations whose identifiers (matching keys) that appear in both tables.

-   `full_join`: Merge and keep observations whose identifiers (matching keys) that appear either table.

-   `anti_join`: Filter out observations whose identifiers (matching keys) that does appears in the right-hand-side table

-   `semi_join`: Filter out observations whose identifiers (matching keys) that does not appear in the right-hand-side table
